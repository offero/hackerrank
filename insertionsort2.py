...
already “sorted” since there’s nothing to its left that is smaller than it.
...
currently) its correct place. Since the array composed of just the first element
is already “sorted”, begin printing from the second element and on.
